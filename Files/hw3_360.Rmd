...
There may be other seasonalities in data like weekly or monthly seasonalities. To observe other seasonalities better, I plotted above 'Daily Electric Consumption in Turkey'. I took average of consumption in the day for this case.
...
Now that I'm sure that there is weekly seasonality, I can made time series in frequency 7. Here is my plot and ACF of time series. 
...
I decomposed my series and created an ARIMA model. After that, I predicted next 14 days. Looking at my predictions and my error values, I did a good job except religious holidays. You can reach my related code from [here](https://bu-ie-360.github.io/spring21-OzlemSenel/Files/hw3_360.Rmd).
